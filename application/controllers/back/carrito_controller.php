...
class Carrito_controller extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('back/carrito_model');
	...
	public function index()
	{
		...
		if ($session_data) 
		{
			$this->load->view('back/carrito/carrito_view' );
		}
		
		$this->load->view('partes/footer_view');
	}

	//Este método llama a la página catalogo, con el carrito si está logueado
	public function catalogo()
	{
		...
		$this->load->view('partes/header_view', $data);
		$this->load->view('partes/navbar_view');
		$this->load->view('front/Catalogo', $dat);
		$this->load->view('partes/footer_view');
	}
	/**Muestra el catalogo solo de las opciones deseadas */
	public function catalogo_cuento()
	{
		$dat = array('productos' => $this->producto_model->get_cuento());

		$data = array('titulo' => 'Cuento');
		$session_data = $this->session->userdata('logged_in');
		$data['perfil_id'] = $session_data['perfil_id'];
		$data['usuario'] = $session_data['usuario'];
		$data['id_usuario'] = $session_data['id_usuario'];
	...
	public function catalogo_ilustracion()
	{
	...
	public function catalogo_historieta()
	{
		$dat = array('productos' => $this->producto_model->get_historieta());

		$data = array('titulo' => 'Historieta');
		$session_data = $this->session->userdata('logged_in');
		$data['perfil_id'] = $session_data['perfil_id'];
		$data['usuario'] = $session_data['usuario'];
		$data['id_usuario'] = $session_data['id_usuario'];
	...
	public function catalogo_poesiaYteatro()
	{
	...
	public function catalogo_aventura()
	{
	...
	/*public function electrodomesticos()
	{
		...
		$this->load->view('back/carrito/electrodomesticos_view', $dat);
		$this->load->view('partes/footer_view');
	}*/
    ...
    public function guarda_compra()
	{
        ...
        $this->load->view('partes/header_view', $data);
		$this->load->view('partes/navbar_view', $data);
		$this->load->view('back/carrito/compra-exitosa_view');
		$this->load->view('partes/footer_view');
