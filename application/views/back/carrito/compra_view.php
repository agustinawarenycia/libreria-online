    ...
    <section class="container">
        ...
        <div class="row">
            <div class="col-6"></div>
            <div class="col-4">
                <a type="button" class="btn btn-outline-danger" href="<?php echo base_url("carrito");?>">Volver al carrito</a>
                <a type="button" class="btn btn-outline-secondary" href="<?php echo base_url("confirma_compra");?>">Finalizar Compra</a>
            </div>
            <div class="col-2"></div>
        </div>
    </section>
